...
Item {
    ...
    readonly property bool isActive: hasCurrent || isDetached
    readonly property real nonAnimWidth: isActive ? children.find(c => c.shouldBeActive)?.implicitWidth ?? content.implicitWidth : 0
    readonly property real nonAnimHeight: isActive ? children.find(c => c.shouldBeActive)?.implicitHeight ?? content.implicitHeight : 0
